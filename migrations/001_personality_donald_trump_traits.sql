-- Personality Donald Trump: Core traits table
...
CREATE TABLE IF NOT EXISTS personality_donald_trump_traits (
...
CREATE INDEX IF NOT EXISTS idx_pdt_traits_profile_cat
    ON personality_donald_trump_traits(profile_slug, category);
CREATE INDEX IF NOT EXISTS idx_pdt_traits_profile_layer
    ON personality_donald_trump_traits(profile_slug, layer);
CREATE INDEX IF NOT EXISTS idx_pdt_traits_profile_weight
    ON personality_donald_trump_traits(profile_slug, weight DESC);
CREATE INDEX IF NOT EXISTS idx_pdt_traits_tags
    ON personality_donald_trump_traits USING GIN(tags);
CREATE INDEX IF NOT EXISTS idx_pdt_traits_examples
    ON personality_donald_trump_traits USING GIN(examples);
