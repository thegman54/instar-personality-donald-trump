...
@register_tool
class PersonalityDonaldTrumpListTool(BaseTool):
    """List available personality categories and data store counts."""

    @property
    def name(self) -> str:
        return "personality_donald_trump_list"
    ...
    def description(self) -> str:
        return (
            ...
            "and reaction pattern counts. Use before personality_donald_trump_read "
        ...
        try:
            async with pool.acquire() as conn:
                ...
                quote_count = await conn.fetchval(
                    "SELECT COUNT(*) FROM personality_donald_trump_quotes WHERE profile_slug = $1",
                    profile_slug,
                )
            ...
            log.error("personality_donald_trump_list_error", error=str(e))
