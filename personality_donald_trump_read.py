"""
personality_donald_trump_read — retrieve personality data across all four stores.
...
@register_tool
class PersonalityDonaldTrumpReadTool(BaseTool):
    """Load Donald Trump personality traits, quotes, lexicon, and reactions."""

    @property
    def name(self) -> str:
        return "personality_donald_trump_read"
    ...
    async def execute(
        ...
        **kwargs,
        ...
        log.info("personality_donald_trump_read",
        ...
        try:
            ...
            log.error("personality_donald_trump_read_error", error=str(e))
